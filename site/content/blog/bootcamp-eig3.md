...
![Les EIG de la promotion 3 sont rassemblés dans un grand espace. Certains sont assis sur des chaises, d'autres sont debout.](/img/photo-blogpost-bootcamp-eig3.jpg)
...
-	**comprendre les enjeux liés aux logiciels libres dans l’administration**. Bastien peut partager son expérience de développeur et de mainteneur de projets libres et répondre à vos questions. Il a notamment publié un [mini-guide sur l’ouverture du code source d’un logiciel](/img/mini-guide-logiciel-libre.pdf) et anime des ateliers pour les EIG. 
...
-	**animer un groupe de travail sur les enjeux éthiques de certains projets**. Dans le cadre de la promotion EIG 3, Simon Chignard, aux côtés d’autres acteurs, organise un groupe de travail pour certains défis qui comportent des enjeux sociétaux et éthiques ([Open Justice](/defis/open-justice/), [DataJust](/defis/datajust/), [Open Chronic](/defis/open-chronic/), [CibNAV](/defis/cibnav/)). Pendant l'année, les équipes défis se rassembleront régulièrement pour travailler sur différents aspects liés à la redevabilité des algorithmes publics : impact, données utilisées, explicabilité, biais, etc.

...
Pour mettre en relief les chiffres EIG, nous avons fait appel aux compétences de [Bastien Guerry](/personnes/bastien-guerry/), ancien EIG, qui a réalisé les visualisations de cet article (celles-ci sont également consultables sur le [site](https://data.eig-forever.org/) créé pour l'occasion).
...
On peut citer en exemple des services des ministères comme ceux de [l’Intérieur](/defis/ia-flash/), de la [Culture](/defis/mcc-inventaire-des-orgues/), ou de l’[Éducation Nationale](/defis/mesri-la-machine-a-donnees/). Cependant, le programme EIG s'adresse aussi à d'autres types de structures comme [l’Agence Française de Développement (AFD)](/defis/afd-geodata/) qui est un établissement public à caractère industriel et commercial (EPIC), à des Autorités Administratives Indépendantes comme [l’Autorité de Régulation des communications électroniques et des postes (Arcep)](/defis/datareg/) ou encore à [l'Agence Bio](https://www.agencebio.org/) qui est un groupement d'intérêt public.
...
![Données sur le genre des EIG](/img/genre.PNG)
...
![Données sur le financement d'EIG](/img/financement.PNG)
...
La création du site EIG en février 2018 et du blog qu'il héberge a ouvert une autre plateforme de présentation du programme. 29 articles y ont été publiés et une attention particulière a été apportée à ce que les EIG y publient du contenu. Ils peuvent ainsi [faire des retours d'expériences](/blog/retour-experience-defi-brigade-numerique/), [partager des points de vue](/blog/pourquoi-devenir-eig/)...  C'est également l'endroit où peuvent s'exprimer les [acteurs de l'écosystème EIG comme la FING](/blog/fing-algo/).
